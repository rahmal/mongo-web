...
Mongo Web Admin is a small Sinatra app that partially replicates CouchDB's Web-based frontend caled Futon. Futon is a simple clean GUI to CouchDB's REST interface. This app is a modified version of Futon, making CouchDB's web interface compatible with MongoDB.
