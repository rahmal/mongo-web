...
couchTests.attachments= function(debug) {
  ...
  var lorem = CouchDB.request("GET", "/public/script/test/lorem.txt").responseText;
  ...
  var lorem_b64 = CouchDB.request("GET", "/public/script/test/lorem_b64.txt").responseText;
